...
import robomasterPage from '../../assets/robomaster-page.jpg'
import robomasterSide from '../../assets/robomaster-side.jpg'

const SeriaRobomaster = () => {
    ...
    return(
        <PageLayout banner={robomasterPage} name={"Robomaster"}>
            <Container className="container">
                <H2>Robomaster</H2>
                <Row className="row mb-4">
                    <PageCard product={singleProduct1}/>
                    <SideImage image={robomasterSide} alt="Robomaster S1"/>
                </Row>
                <H2>Accesorii</H2>
                <StyledListGroup>
                <ListGroup className="row mb-3" horizontal defaultActiveKey="#accesorii-robomaster">
                    <StyledListItem className="col-md-2" action href="#accesorii-robomaster" onClick={() => setRescoure(AccesoriiRobomaster())}>Robomaster</StyledListItem>
                </ListGroup>
                </StyledListGroup>
...
export default SeriaRobomaster
