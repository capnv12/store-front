...
import phantomPage from '../../assets/phantom-page.jpg'
import phantomSide from '../../assets/phantom-side.png'
...
const SeriaPhantom = () => {
    ...
    return(
        <PageLayout banner={phantomPage} name={"Phantom"}>
            <Container className="container">
                <H2>Phantom</H2>
                <Row className="row mb-4">
                    <PageCard product={singleProduct1}/>
                    <SideImage image={phantomSide} alt="Phantom 4 Pro"/>
                ...
                <H2>Accesorii</H2>
                <StyledListGroup>
                <ListGroup className="row mb-3" horizontal defaultActiveKey="#accesorii-phantom4">
                    <StyledListItem className="col-md-2" action href="#accesorii-phantom4" onClick={() => setRescoure(AccesoriiPhantom4())}>Phantom 4</StyledListItem>
                    <StyledListItem className="col-md-2" action href="#accesorii-phantom3" onClick={() => setRescoure(AccesoriiPhantom3())}>Phantom 3</StyledListItem>
                </ListGroup>
                </StyledListGroup>
